...
func addStorableFlags(cmd *cobra.Command) {
	...
	cmd.Flags().String("storable.barn.address", "0x10e138877df69Ca44Fdc68655f86c88CDe142D7F", "Address of the barn contract")
	cmd.Flags().String("storable.governance.address", "0x4cAE362D7F227e3d306f70ce4878E245563F3069", "Address of the governance contract")
	cmd.Flags().String("storable.yieldFarming.address", "0xb0fa2beee3cf36a7ac7e99b885b48538ab364853", "Address of the yield farming staking contract")
	...
	cmd.Flags().String("storable.smartYieldRewards.pool-factory-address", "0x2e93403C675Ccb9C564edf2dC6001233d0650582", "Address of rewards pool factory")
}
