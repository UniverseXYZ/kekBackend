...
func (a *API) handleSeniorRedeems(c *gin.Context) {
	...
	rows, err := a.db.Query(`select b.sy_address , b.buyer_address,b.senior_bond_id,b.underlying_in,
									b.gain ,b.for_days,
									r.fee 
								...
								where (r.owner_address = $1 or b.buyer_address = $1)`, userAddress)
...
func (a *API) handleJuniorRedeems(c *gin.Context) {
	...
	rows, err := a.db.Query(`select b.sy_address,b.buyer_address,b.junior_bond_id,
									b.tokens_in,b.matures_at,
									r.underlying_out
